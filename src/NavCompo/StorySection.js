...
function StorySectionN() {
  return (
    <div className="CenterContainer">
      <div className="LayoutStory" style={{ marginTop: "50px" }}>
        ...
        <div className="rght-Story">
          ...
          <div className="Heading">
            <p>
              ...
              we now made a brave move into healthtech to make medicine
              accessible for everyone at any point of time.
            </p>
            <p>
              {" "}
              We believe that emergencies won’t come with invitations to be
              prepared. We Mediwheels are here to help you 24/7 serving
              excelence.
            </p>
          </div>
        </div>
